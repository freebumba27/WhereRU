...
public class VoiceCommandService extends Service {
    ...
    public void onCreate() {
        ...
        if (!VoiceCommandService.this.mIsListening) {
            VoiceCommandService.this.mSpeechRecognizer.startListening(VoiceCommandService.this.mSpeechRecognizerIntent);
            VoiceCommandService.this.mIsListening = true;
...
//            Log.d(TAG, "onReadyForSpeech"); //$NON-NLS-1$
        ...
        public void onResults(Bundle results) {
            ...
            Toast.makeText(VoiceCommandService.this, "Word captured: " + text, Toast.LENGTH_LONG).show();
        }
